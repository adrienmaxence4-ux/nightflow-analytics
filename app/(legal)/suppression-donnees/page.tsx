...
const STATUS: Record<string, { label: string; tone: string }> = {
  completed: { label: "Terminée", tone: "text-neon-lime" },
  partial: { label: "Partielle", tone: "text-neon-amber" },
  failed: { label: "Échouée", tone: "text-neon-pinksoft" },
};
...
export default async function DataDeletionPage({
  ...
  return (
    <main className="mx-auto flex max-w-[720px] flex-col gap-6 px-6 py-14">
      ...
      {code && (
        <section className="rounded-2xl border border-glass-hi bg-glass-2 p-5">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="text-body text-ink-dim">
          ...
          <a
            ...
            className="text-neon-cyansoft hover:underline"
          >
