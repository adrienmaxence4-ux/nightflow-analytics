 ...
 * sur la couleur héritée — un texte brun foncé sur un fond terre cuite, à
 * 2,4:1. Les tailles `md` et `lg` y échappaient par hasard, parce que
 * `text-[17px]` est reconnu comme une taille arbitraire.
 */
